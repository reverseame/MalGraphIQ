...
# Import each phase
from transition_matrix_and_graphs import main as transition_matrix_main
from behavioral_pattern_occurrences import main as behavior_pattern_main
from plot_catalog_matches import main as plot_matches_main
...
def parse_arguments():
    ...
    parser_transition = subparsers.add_parser("transition_matrix", help="Transition Matrix and Graphs phase.")
    ...
    parser_behavior = subparsers.add_parser("behavior_patterns", help="Behavior Pattern Occurrences phase.")
    ...
    parser_plot = subparsers.add_parser("plot_matches", help="Plot Catalog Matches phase.")
